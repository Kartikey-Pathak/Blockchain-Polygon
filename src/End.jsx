...
function End() {
    ...
    return (
        <div className=" w-full max-w-full h-[30rem] mt-10 flex justify-center items-center relative">
            ...
            <div className="absolute z-30 left-10 md:left-20 flex items-center justify-center w-[80%] md:w-[40vw]">
                ...
                <label htmlFor="txt"><div className=" cursor-pointer hover:bg-white/70 transition-all flex items-center justify-center size-8 md:size-10 bg-white rounded-full"><i className="fa-solid text-sm md:text-xl text-black fa-arrow-right"></i></div></label>
            </div>
        </div>
    )
}
