...
function Data() {
    ...
    return (
        <div className=" w-full max-w-screen md:min-h-screen h-[90rem] relative bg-black">
            <header>
                <Nav />
            </header>
            ...
            <main>
                <div className="w-ful max-w-screen h-[35rem] flex items-center justify-center">
                    <div className="mt-50 flex items-center justify-center w-full h-full md:flex-row flex-col ">
                        {/* graph */}
                        <div className="md:w-[90%] w-[80%] h-[40vh]  md:order-1 flex items-center justify-center rounded-4xl  bg-white">
                            f
                        ...
                        {/* information */}
                        <div className=" h-full md:w-full flex items-start flex-col md:overflow-y-scroll md:order-2">
                            <h1 className="text-4xl text-white font-semibold mt-3 mx-auto">Coin Info</h1>
                            <div className=" h-20 w-[38vw]  md:w-[17vw]  m-10 flex flex-col">
