...
function Header(){
    return(
        <div>
             ...
             <div className=" bg-white/20 h-10 hover:bg-white/50 transition duration-150 cursor-pointer rounded-2xl w-80 border-2 border-black mt-28 flex justify-center items-center gap-2">
